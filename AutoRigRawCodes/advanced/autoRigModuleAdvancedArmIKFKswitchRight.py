...
#beforehand create "clavicle_GUID1", "humerus_GUID1", "radius_GUID1", "wrist_GUID1", "ikUpVectorArm_GUID1", "armGuid_GRP", "humerus_FK_CON", 'hand_IK_CON', 'ikUpVectorArm_CON', 'clavicle_CON' , "referenceFinger_CON"
...
cmds.duplicate( "humerus_FK_CON1", n="radius_FK_CON" )
cmds.duplicate( "humerus_FK_CON1", n="wrist_FK_CON" )

#create hand controllers
cmds.duplicate( "referenceFinger_CON1", n="metacarpalThumb_CON") 
cmds.duplicate( "referenceFinger_CON1", n="thumb001_CON") 
cmds.duplicate( "referenceFinger_CON1", n="thumb002_CON")  
cmds.duplicate( "referenceFinger_CON1", n="metacarpalIndex_CON") 
cmds.duplicate( "referenceFinger_CON1", n="index001_CON") 
cmds.duplicate( "referenceFinger_CON1", n="index002_CON") 
cmds.duplicate( "referenceFinger_CON1", n="index003_CON")  
cmds.duplicate( "referenceFinger_CON1", n="metacarpalMajor_CON") 
cmds.duplicate( "referenceFinger_CON1", n="major001_CON") 
cmds.duplicate( "referenceFinger_CON1", n="major002_CON") 
cmds.duplicate( "referenceFinger_CON1", n="major003_CON") 
cmds.duplicate( "referenceFinger_CON1", n="metacarpalAnnular_CON") 
cmds.duplicate( "referenceFinger_CON1", n="annular001_CON") 
cmds.duplicate( "referenceFinger_CON1", n="annular002_CON") 
cmds.duplicate( "referenceFinger_CON1", n="annular003_CON")  
cmds.duplicate( "referenceFinger_CON1", n="metacarpalPinky_CON") 
cmds.duplicate( "referenceFinger_CON1", n="pinky001_CON") 
cmds.duplicate( "referenceFinger_CON1", n="pinky002_CON") 
cmds.duplicate( "referenceFinger_CON1", n="pinky003_CON") 


#add _CON to namespace 
cmds.rename( 'hand_IK_CON1', f":{nspc}:hand_IK_CON" )
cmds.rename( 'ikUpVectorArm_CON1', f":{nspc}:upVector_IK_CON" )
cmds.rename( 'clavicle_CON1', f":{nspc}:clavicle_CON" )

cmds.rename( 'humerus_FK_CON1', f":{nspc}:humerus_FK_CON" )
...
cmds.matchTransform(f"{nspc}:ikHand_parentAttach_BUF", "wrist_GUID1")
cmds.matchTransform(f"{nspc}:clavicle_parentAttach_BUF", "clavicle_GUID1")
cmds.matchTransform(f"{nspc}:humerusRootAttach_BUF", "humerus_GUID1")
cmds.matchTransform(f"{nspc}:handParentAttach_BUF", "wrist_GUID1")
cmds.matchTransform(f"{nspc}:humerusFKAttach_BUF", "humerus_GUID1")
cmds.matchTransform(f"{nspc}:clavicle_childAttach_BUF", "clavicle_GUID1")


cmds.matchTransform(f"{nspc}:root_IK_BUF","humerus_GUID1") 
cmds.matchTransform(f"{nspc}:clavicle_JNT","clavicle_GUID1")



cmds.matchTransform(f"{nspc}:clavicle_CON","clavicle_GUID1")
cmds.matchTransform(f"{nspc}:hand_IK_CON", "wrist_GUID1")
cmds.matchTransform(f"{nspc}:upVector_IK_CON", "ikUpVectorArm_GUID1")


cmds.matchTransform(f"{nspc}:humerus_IK_JNT","humerus_GUID1")
cmds.matchTransform(f"{nspc}:radius_IK_JNT","radius_GUID1")
cmds.matchTransform(f"{nspc}:wrist_IK_JNT","wrist_GUID1")

cmds.matchTransform(f"{nspc}:humerus_FK_CON","humerus_GUID1")
cmds.matchTransform(f"{nspc}:radius_FK_CON","radius_GUID1")
cmds.matchTransform(f"{nspc}:wrist_FK_CON","wrist_GUID1")
...
cmds.addAttr( at="float", ln="b1Length", nn="B1 Length", dv=1.832, k=True)
cmds.addAttr( at="float", ln="b2Length", nn="B2 Length", dv=1.78, k=True)
...
#match joints with the _GUID1 tools 
cmds.matchTransform(f"{nspc}:metacarpalThumb_JNT","metacarpalThumb_GUID1")
cmds.matchTransform(f"{nspc}:thumb001_JNT","thumb001_GUID1")
cmds.matchTransform(f"{nspc}:thumb002_JNT","thumb002_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalIndex_JNT","metacarpalIndex_GUID1")
cmds.matchTransform(f"{nspc}:index001_JNT","index001_GUID1")
cmds.matchTransform(f"{nspc}:index002_JNT","index002_GUID1")
cmds.matchTransform(f"{nspc}:index003_JNT","index003_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalMajor_JNT","metacarpalMajor_GUID1")
cmds.matchTransform(f"{nspc}:major001_JNT","major001_GUID1")
cmds.matchTransform(f"{nspc}:major002_JNT","major002_GUID1")
cmds.matchTransform(f"{nspc}:major003_JNT","major003_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalAnnular_JNT","metacarpalAnnular_GUID1")
cmds.matchTransform(f"{nspc}:annular001_JNT","annular001_GUID1")
cmds.matchTransform(f"{nspc}:annular002_JNT","annular002_GUID1")
cmds.matchTransform(f"{nspc}:annular002_JNT","annular002_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalPinky_JNT","metacarpalPinky_GUID1")
cmds.matchTransform(f"{nspc}:pinky001_JNT","pinky001_GUID1")
cmds.matchTransform(f"{nspc}:pinky002_JNT","pinky002_GUID1")
cmds.matchTransform(f"{nspc}:pinky002_JNT","pinky002_GUID1")
 
 
#match _CON with the _GUID1 tools 
cmds.matchTransform(f"{nspc}:metacarpalThumb_CON","metacarpalThumb_GUID1")
cmds.matchTransform(f"{nspc}:thumb001_CON","thumb001_GUID1")
cmds.matchTransform(f"{nspc}:thumb002_CON","thumb002_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalIndex_CON","metacarpalIndex_GUID1")
cmds.matchTransform(f"{nspc}:index001_CON","index001_GUID1")
cmds.matchTransform(f"{nspc}:index002_CON","index002_GUID1")
cmds.matchTransform(f"{nspc}:index003_CON","index003_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalMajor_CON","metacarpalMajor_GUID1")
cmds.matchTransform(f"{nspc}:major001_CON","major001_GUID1")
cmds.matchTransform(f"{nspc}:major002_CON","major002_GUID1")
cmds.matchTransform(f"{nspc}:major003_CON","major003_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalAnnular_CON","metacarpalAnnular_GUID1")
cmds.matchTransform(f"{nspc}:annular001_CON","annular001_GUID1")
cmds.matchTransform(f"{nspc}:annular002_CON","annular002_GUID1")
cmds.matchTransform(f"{nspc}:annular003_CON","annular003_GUID1")
 
cmds.matchTransform(f"{nspc}:metacarpalPinky_CON","metacarpalPinky_GUID1")
cmds.matchTransform(f"{nspc}:pinky001_CON","pinky001_GUID1")
cmds.matchTransform(f"{nspc}:pinky002_CON","pinky002_GUID1")
cmds.matchTransform(f"{nspc}:pinky003_CON","pinky003_GUID1")
...
# delete arm guids 
cmds.delete( "clavicle_GUID1", "humerus_GUID1", "radius_GUID1", "wrist_GUID1", "ikUpVectorArm_GUID1", "armGuid_GRP" )

#delete _GUID1 and creation tools
cmds.delete("metacarpalThumb_GUID1", "thumb001_GUID1", "thumb002_GUID1", "metacarpalMajor_GUID1", "major001_GUID1", "major002_GUID1", "major003_GUID1", "metacarpalAnnular_GUID1", "annular001_GUID1", "annular002_GUID1", "annular003_GUID1", "metacarpalPinky_GUID1", "pinky001_GUID1", "pinky002_GUID1", "pinky003_GUID1", "metacarpalIndex_GUID1", "index001_GUID1", "index002_GUID1", "index003_GUID1", "referenceFinger_CON")
