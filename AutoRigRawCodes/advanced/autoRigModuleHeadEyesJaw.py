...
cmds.group(n="headSpaceSwitchRotation_BUF", em=True)
cmds.matchTransform(f"{nspc}:headSpaceSwitchRotation_BUF" , f"{nspc}:head_CON")
cmds.parent(f"{nspc}:headSpaceSwitchRotation_BUF", f"{nspc}:neck_CON")
cmds.parent(f"{nspc}:head_CON", f"{nspc}:headSpaceSwitchRotation_BUF")



cmds.group(n="headSpaceSwitchSender_BUF", em=True)
cmds.matchTransform(f"{nspc}:headSpaceSwitchSender_BUF" , f"{nspc}:head_CON")
cmds.parent(f"{nspc}:headSpaceSwitchSender_BUF", f"{nspc}:head_CON")


cmds.group(n="lookAtSpaceSwitchRotation_BUF", em=True)
cmds.matchTransform(f"{nspc}:lookAtSpaceSwitchRotation_BUF" , f"{nspc}:lookAtParentAttach_BUF")
cmds.parent(f"{nspc}:lookAtSpaceSwitchRotation_BUF", f"{nspc}:lookAtParentAttach_BUF")
cmds.parent(f"{nspc}:lookAt_CON", f"{nspc}:lookAtSpaceSwitchRotation_BUF")


cmds.setAttr ( f"{nspc}:headSpaceSwitchSender_BUF " + ".useOutlinerColor" , True)
cmds.setAttr ( f"{nspc}:headSpaceSwitchSender_BUF " + ".outlinerColor" , 255,255,0)

cmds.setAttr ( f"{nspc}:headSpaceSwitchRotation_BUF " + ".useOutlinerColor" , True)
cmds.setAttr ( f"{nspc}:headSpaceSwitchRotation_BUF " + ".outlinerColor" , 255,255,0)

cmds.setAttr ( f"{nspc}:lookAtSpaceSwitchRotation_BUF " + ".useOutlinerColor" , True)
cmds.setAttr ( f"{nspc}:lookAtSpaceSwitchRotation_BUF " + ".outlinerColor" , 255,255,0)
