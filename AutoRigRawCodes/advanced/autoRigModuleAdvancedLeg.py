...
cmds.rename( 'ikFoot_CON', f':{nspc}:ikFoot_CON' )
cmds.rename( 'ikUpVectorLeg_CON', f':{nspc}:ikUpVector_CON' )
...
cmds.matchTransform(f'{nspc}:endToes_JNT','endToes_GUID')
...
cmds.matchTransform(f'{nspc}:heelTwist_BUF', 'heel_GUID')
cmds.matchTransform(f'{nspc}:endFootTwist_BUF', 'endToes_GUID')
cmds.matchTransform(f'{nspc}:midFootTwist_BUF', 'midFoot_GUID')

cmds.matchTransform(f'{nspc}:exterior_BUF', 'exterior_GUID')
cmds.matchTransform(f'{nspc}:interior_BUF', 'interior_GUID')
cmds.matchTransform(f'{nspc}:heel_BUF', 'heel_GUID')
cmds.matchTransform(f'{nspc}:endToes_BUF', f'{nspc}:endToes_JNT')

cmds.matchTransform(f'{nspc}:upVectorIKToes_BUF', 'upVectorIKToes_GUID')
cmds.matchTransform(f'{nspc}:midFootTorsion_BUF', 'midFoot_GUID')

cmds.matchTransform(f'{nspc}:midFoot_BUF', f'{nspc}:midFoot_JNT')
cmds.matchTransform(f'{nspc}:ikAnkle_BUF', f'{nspc}:ankle_JNT')
cmds.matchTransform(f'{nspc}:upVectorIKAnckle_BUF', 'upVectorIKAnkle_GUID')
...
cmds.delete( "femur_GUID", "tibia_GUID", "ankle_GUID", "endToes_GUID", "ikUpVectorLeg_GUID", "heel_GUID", "midFoot_GUID", "midToes_GUID", "exterior_GUID", "interior_GUID", "upVectorIKToes_GUID", "upVectorIKAnkle_GUID" )
...
#add femur constraints and Scale connections from parent attach to Leg Joints 
